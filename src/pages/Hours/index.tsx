...
const Times: React.FC = () => {
    ...
    return (
        <ScrollView className="w-full pb-20 bg-[#25a55f]">
                    ...
                    hours.length == 0 ?
                        ...
                        (
                            <View className="w-full items-end">
                                <TouchableOpacity className="rounded-md bg-[#fff] px-2 py-1 mt-3 flex flex-row justify-center items-center" onPress={() => setModalVisible(true)}>
                                ...
                                <View className="w-full flex flex-row flex-wrap justify-between items-center">
...

                                    {
                                        hour.min_carbohydrate && hour.max_carbohydrate && (
                                            <View className="flex flex-row flex-wrap w-1/2">
            ...
            >
                ...
                <View className="bg-[#00000090] w-full h-full items-center px-8 py-10 relative">
